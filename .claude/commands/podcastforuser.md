...
You will create a favorites list in the supabse table shared_favorites using the user id of the current user and the topic supplied by the user using the supabase rest api and the service key store in the environment variable.  
